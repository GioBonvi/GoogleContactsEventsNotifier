...
var i18n = {
  ...
  'he': {
    ...
    'Birthdays in {0} days': 'ימי הולדת ב-{0} הימים הקרובים',
    'Anniversaries today': 'ימי נישואין היום',
    'Anniversaries tomorrow': 'ימי נישואין מחר',
    'Anniversaries in {0} days': 'ימי נישואין ב-{0} הימים הקרובים',
    'Custom events today': 'אירועים מיוחדים היום',
    'Custom events tomorrow': 'אירועים מיוחדים מחר',
    'Custom events in {0} days': 'אירועים מיוחדים ב-{0} הימים הקרובים',
