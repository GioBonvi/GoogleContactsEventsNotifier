...
var i18n = {
  ...
  'pt-br': {
    ...
    'Years': 'Anos',
    'Events': 'Eventos',
    'Birthdays today': 'Aniversários de hoje',
    'Birthdays tomorrow': 'Aniversários de amanhã',
    'Birthdays in {0} days': 'Aniversários em {0} dias',
    'Anniversaries today': 'Aniversários de hoje',
    'Anniversaries tomorrow': 'Aniversários de amanhã',
    'Anniversaries in {0} days': 'Aniversários em {0} dias',
    'Custom events today': 'Eventos personalizados de hoje',
    'Custom events tomorrow': 'Eventos personalizados de amanhã',
    'Custom events in {0} days': 'Eventos personalizados em {0} dias',
    'Hey! Don\'t forget these events': 'Hey! Não esqueça destes eventos',
    'version': 'versão',
    'dd-MM-yyyy': 'dd-MM-yyyy',
    'Mobile phone': 'Número do celular',
    'Work phone': 'Número de trabalho',
    'Home phone': 'Número de casa',
    'Main phone': 'Número principal',
    'Other phone': 'Outro número',
    ...
    'Work email': 'Email de trabalho',
    'Other email': 'Outro email',
    'It looks like you are using an outdated version of this script': 'Parece você tem uma versão desatualizada deste script',
    'You can find the latest one here': 'Encontre a última versão aqui',
  },
  /* To add a language:
  '[lang-code]': {
