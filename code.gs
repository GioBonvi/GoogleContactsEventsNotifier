...
var i18n = {
  ...
  'de': {
    ...
    'Other phone': 'Nummer (andere)',
    'Home fax': 'Fax (Zuhause)',
    'Work fax': 'Fax (Arbeit)',
    'Google voice': 'Google Voice',
    'Pager': 'Pager',
    'Home email': 'Private E-Mail',
    'Work email': 'Arbeits E-Mail',
    'Other email': 'E-Mail (andere)',
    ...
    'You can find the latest one here': 'Die aktuellste Version findest du hier', // Using feminime version of 'latest', because it refers to 'version'. There's possibility it won't fit into diffrent context.
  },
  'pl': {
    'Age': 'Wiek',
    'Years': 'Lat(a)',
